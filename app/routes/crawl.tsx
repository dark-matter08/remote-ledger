...
const TYPE_LABEL: Record<string, string> = { find: "Find new jobs", feeds: "Free job boards", careers: "Company career pages", update: "Update descriptions", full: "Full refresh", scan: "Folder / repo scan", note: "Knowledge capture", clip: "Clipped posting", email: "Email sync", match: "Match analysis", tailor: "Résumé tailor", cover: "Cover letter", prep: "Interview prep", answers: "Draft answers" };
